...
const BILLING_ACCOUNT_EXPORT_DATASET = process.env.BILLING_ACCOUNT_EXPORT_DATASET || 'billing_daily_costs';
const BILLING_ACCOUNT_EXPORT_DATASET_TABLE = process.env.BILLING_ACCOUNT_EXPORT_DATASET_TABLE || 'billing-export-view';

// The budget usage datasets and tables are defined in bootstrap/bigquery.tf.
const BUDGET_USAGE_DATASET = process.env.BUDGET_USAGE_DATASET || 'billing_budget_usages';
const BUDGET_USAGE_DATASET_BUDGET_TABLE = process.env.BUDGET_USAGE_DATASET_BUDGET_TABLE || 'budgets';
const BUDGET_USAGE_DATASET_BUDGET_USAGE_TABLE = process.env.BUDGET_USAGE_DATASET_BUDGET_USAGE_TABLE || 'usages';
